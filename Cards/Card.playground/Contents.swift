...
//закрыли возможность использовать пустой экземпляр
...
class BackSideLine: CAShapeLayer, ShapeLayerProtocol {
    required init(size: CGSize, fillColor: CGColor) {
        ...
        for _ in 1...15 {
            ...
            let randomYStart = Int.random(in: 0...Int(size.height)) // координаты конца очередной линии
...
class MyViewController : UIViewController {
    override func loadView() {
        ...
        let secondCardView = CardView<CircleShape>(frame: CGRect(x: 100, y: 0, width: 120, height: 150), color: .red)
